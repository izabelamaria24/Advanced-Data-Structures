    ...
    private:
        ...
        void printHelper(NodePtr root2, std::string indent, bool last) const {
            if (root2 != T_null) {
                ...
                std::string sColor = root2->color?"RED":"BLACK";
                std::cout<<root2->data<<"("<<sColor<<")"<<std::endl;
                printHelper(root2->left, indent, false);
                printHelper(root2->right, indent, true);
            }
        }
